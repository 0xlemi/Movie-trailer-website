...
duration = "81"
toy_story = media.Movie(movie_title, duration, movie_storyline, 
...
duration = "162"
avatar = media.Movie(movie_title, duration, movie_storyline,
		 movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "108"
school_of_rock = media.Movie(movie_title, duration, movie_storyline, 
				movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "152"
the_dark_knight = media.Movie(movie_title, duration, movie_storyline, 
				movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "109"
friends_with_benefits = media.Movie(movie_title, duration, movie_storyline, 
						movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "41"
num_seasons = "5"
breaking_bad = media.TvShow(title, duration, storyline,
...
duration = "55"
num_seasons = "6"
game_of_thrones = media.TvShow(title, duration, storyline,
    				 image_url, youtube_url, num_seasons)
...
duration = "60"
num_seasons = "1"
cosmos = media.TvShow(title, duration, storyline,
			 image_url, youtube_url, num_seasons)
