...
duration = "81"
toy_story = media.Movie(movie_title, duration, movie_storyline, movie_image_url, movie_youtube_url, date_on_theater)
movie_title = "Avatar"
...
duration = "162"
avatar = media.Movie(movie_title, duration, movie_storyline, movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "108"
school_of_rock = media.Movie(movie_title, duration, movie_storyline, movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "152"
the_dark_knight = media.Movie(movie_title, duration, movie_storyline, movie_image_url, movie_youtube_url, date_on_theater)
...
duration = "109"
friends_with_benefits = media.Movie(movie_title, duration, movie_storyline, movie_image_url, movie_youtube_url, date_on_theater)
#***********
#TVSHOWS
#***********
title = "Breaking Bad"
storyline = "A chemistry teacher diagnosed with a terminal lung cancer teams up with his former student to cook and sell crystal meth."
image_url = "http://ia.media-imdb.com/images/M/MV5BMTQ0ODYzODc0OV5BMl5BanBnXkFtZTgwMDk3OTcyMDE@._V1_SY317_CR0,0,214,317_AL_.jpg"
youtube_url = "https://youtu.be/HhesaQXLuRY"
duration = "41"
num_seasons = "5"
breaking_bad = media.TvShow(title, duration, storyline, image_url, youtube_url, num_seasons)

title = "Game of Thrones"
storyline = "Several noble families fight for control of the mythical land of Westeros."
image_url = "http://ia.media-imdb.com/images/M/MV5BNTgxOTI4NzY2M15BMl5BanBnXkFtZTgwMjY3MTM2NDE@._V1_SX214_AL_.jpg"
youtube_url = "https://youtu.be/8ixEWrTLiZg"
duration = "55"
num_seasons = "6"
game_of_thrones = media.TvShow(title, duration, storyline, image_url, youtube_url, num_seasons)

title = "Cosmos"
storyline = "Astronomer Carl Sagan leads us on an engaging guided tour of the various elements and cosmological theories of the universe."
image_url = "http://ia.media-imdb.com/images/M/MV5BMTI0NTg5MjA5OF5BMl5BanBnXkFtZTcwNDMxMTEyMQ@@._V1_SY317_CR13,0,214,317_AL_.jpg"
youtube_url = "https://youtu.be/bSxHZPoQ4JQ"
duration = "60"
num_seasons = "1"
cosmos = media.TvShow(title, duration, storyline, image_url, youtube_url, num_seasons)




# print(cosmos.storyline)
# print(cosmos.num_seasons)
# print(cosmos.duration)
# print(cosmos.title)
# cosmos.show_trailer()

movies_tvshow = [toy_story, avatar, school_of_rock, the_dark_knight, friends_with_benefits, breaking_bad, game_of_thrones, cosmos]
